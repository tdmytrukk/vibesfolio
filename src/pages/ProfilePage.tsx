  ...
  return (
    <div className="mx-auto max-w-xl space-y-8 pb-12">
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="font-heading text-2xl text-foreground mb-1">Profile</h1>
      ...
      >
        <div className="flex items-center gap-2 text-foreground">
          <Link2 size={18} />
          <h2 className="font-heading text-lg">Connected Accounts</h2>
        </div>
        ...
        <div className="flex items-center justify-between py-3">
          ...
          {!isGoogleLinked && (
            <Button variant="outline" size="sm" onClick={handleConnectGoogle} disabled={googleLoading}>
              {googleLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : "Connect"}
            </Button>
          )}
          {isGoogleLinked && (
      ...
      >
        <div className="flex items-center gap-2 text-foreground">
          <CreditCard size={18} />
          <h2 className="font-heading text-lg">Subscription</h2>
        </div>
        <div className="flex items-center justify-between py-3">
          <div>
      ...
      <motion.section
        ...
        className="card-glass border-destructive/20 p-6 space-y-4"
      >
        <div className="flex items-center gap-2 text-destructive">
          <Trash2 size={18} />
          <h2 className="font-heading text-lg">Danger Zone</h2>
        </div>
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete your account, all projects, ideas, prompts, and resources. This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
