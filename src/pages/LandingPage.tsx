    ...
    <div className="bg-gradient-app bg-noise min-h-screen relative">
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 pt-12 pb-16 md:pt-24 md:pb-28 text-center">
        <motion.div
          ...
          <span className="inline-block rounded-pill bg-secondary px-4 py-1.5 text-xs font-medium text-muted-foreground mb-6">Built for vibe-coders and AI learners ✦
